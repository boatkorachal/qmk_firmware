...
[_LOWER] = LAYOUT(
    ...
    CTL_GRV  , KC_1     , KC_2     , KC_3     , KC_4     , KC_5     , KC_6     , KC_7     , KC_8     , KC_9     , KC_0     , KC_BSLS  ,
    _______  , KC_LCBR  , KC_RCBR  , KC_LPRN  , KC_RPRN  , KC_TILD  , KC_PDOT  , KC_UNDS  , KC_PLUS  , KC_LBRC  , KC_RBRC  , _______  ,
...
[_NUMBER] = LAYOUT(
    _______  , _______  , _______  , _______  , _______  , _______  , _______  , _______  , _______  , _______  , _______  , _______  ,
    _______  , _______  , _______  , KC_UP    , _______  , _______  , KC_PERC  , KC_KP_7  , KC_KP_8  , KC_KP_9  , KC_PAST  , KC_DEL   ,
    ...
    _______  , _______  , _______  , _______  , KC_LOCK  , _______  , _______  , KC_KP_0  , KC_PDOT  , XXXXXXX  , KC_PSLS  , _______
),
