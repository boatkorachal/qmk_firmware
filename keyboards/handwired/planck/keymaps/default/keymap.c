 ...
 *        |------+------+------+------+------+------+------+------+------+------+------+------|
 *        | Ctrl | Ctrl |  ⌥   |  ⌘   |MAC_1 |    Space    |MAC_2 |  FN  |      | DYN  |MOUSE |
 *        `-----------------------------------------------------------------------------------'
 */
[_BASE_MAC] = LAYOUT_planck_grid(
    ...
    KC_LCTL  , KC_LCTL  , KC_LALT  , KC_LCMD  , MAC_1  , KC_SPC  , KC_SPC  , MAC_2  , FN       , XXXXXXX  , DYN      , MOUSE
),
...
[_MAC_1] = LAYOUT_planck_grid(
    KC_GRV   , KC_1     , KC_2     , KC_3     , KC_4     , KC_5     , KC_8     , KC_9     , KC_0     , KC_MINS  , KC_EQL   , KC_DEL   ,
    _______  , _______  , _______  , _______  , _______  , KC_6     , KC_7     , _______  , _______  , KC_LBRC  , KC_RBRC  , KC_INS   ,
    _______  , G(KC_Z)  , G(KC_X)  , G(KC_C)  , G(KC_V)  , _______  , KC_LEFT  , KC_DOWN  , KC_UP    , KC_RGHT  , _______  , _______  ,
 ...
 *        `-----------------------------------------------------------------------------------'
 */
[_MAC_2] = LAYOUT_planck_grid(
    KC_GRV   , KC_EXLM  , KC_AT    , KC_HASH  , KC_DLR   , KC_PERC  , KC_CIRC  , KC_AMPR  , KC_ASTR  , KC_LPRN  , KC_RPRN  , _______  ,
    _______  , KC_1     , KC_2     , KC_3     , KC_4     , KC_5     , KC_6     , KC_7     , KC_8     , KC_9     , KC_0     , KC_BSLS  ,
    _______  , KC_LCBR  , KC_RCBR  , KC_PLUS  , KC_UNDS  , KC_TILD  , KC_DOT   , KC_MINS  , KC_EQL   , KC_LBRC  , KC_RBRC  , _______  ,
    _______  , _______  , _______  , _______  , _______  , _______  , _______  , _______  , _______  , _______  , _______  , _______
),
...
[_MAC_N] = LAYOUT_planck_grid(
    _______  , _______  , A(KC_RGHT)  , _______  , _______  , _______     , _______  , G(S(KC_LBRC))  , G(S(KC_RBRC))  , _______  , _______  , KC_DEL   ,
 ...
 *        | Shift|  Z   |  X   |  C   |  V   |  B   |  N   |  M   |  ,   |  .   |  /   |Shift | Enter
 *        |------+------+------+------+------+------+------+------+------+------+------+------|
 *        | NAV  | Ctrl |  ⌥   |  ⌘   |WIN_1 |    Space    |WIN_2 |  FN  |      | DYN  |MOUSE |
 *        `-----------------------------------------------------------------------------------'
 */
[_BASE_WIN] = LAYOUT_planck_grid(
    ...
    KC_LSFT  , KC_Z     , KC_X     , KC_C     , KC_V   , KC_B    , KC_N    , KC_M   , KC_COMM  , KC_DOT   , KC_SLSH  , SFT_ENT  ,
    KC_LCTL  , KC_LCTL  , KC_LWIN  , KC_LALT  , WIN_1  , KC_SPC  , KC_SPC  , WIN_2  , FN       , XXXXXXX  , DYN      , MOUSE
),
...
[_WIN_1] = LAYOUT_planck_grid(
    KC_GRV   , KC_1     , KC_2     , KC_3     , KC_4     , KC_5     , KC_8     , KC_9     , KC_0     , KC_MINS  , KC_EQL   , KC_DEL   ,
    _______  , _______  , _______  , _______  , _______  , KC_6     , KC_7     , _______  , _______  , KC_LBRC  , KC_RBRC  , KC_INS   ,
    _______  , C(KC_Z)  , C(KC_X)  , C(KC_C)  , C(KC_V)  , _______  , KC_LEFT  , KC_DOWN  , KC_UP    , KC_RGHT  , _______  , _______  ,
    _______  , _______  , _______  , _______  , _______  , _______  , _______  , _______  , _______  , _______  , _______  , _______
),
...
[_WIN_N] = LAYOUT_planck_grid(
    _______  , _______  , A(KC_RGHT)  , _______  , _______  , _______     , _______  , C(S(KC_TAB))  , C(KC_TAB)  , _______  , _______  , KC_DEL   ,
    _______  , _______  , KC_HOME     , KC_PGUP  , KC_PGDN  , KC_END      , KC_LEFT  , KC_DOWN       , KC_UP      , KC_RGHT  , _______  , KC_INS   ,
    _______  , _______  , _______     , _______  , _______  , A(KC_LEFT)  , _______  , _______       , _______    , _______  , _______  , _______  ,
    _______  , _______  , _______     , _______  , _______  , _______     , _______  , _______       , _______    , _______  , _______  , _______
),
...
[_DYN] = LAYOUT_planck_grid(
    _______  , _______  , BASE_WIN  , _______    , _______    , _______          , _______          , _______   , _______  , _______  , _______  , _______  ,
